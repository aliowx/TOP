...
Revision ID: dd8847266e7f
Revises: df2350c049e9
Create Date: 2024-12-23 07:04:04.151554
...
def upgrade() -> None:
    ...
    sa.Column('pox', sa.Float(), nullable=True),
    sa.Column('poy', sa.Float(), nullable=True),
